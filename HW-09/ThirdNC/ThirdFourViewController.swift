...
class ThirdFourViewController: UIViewController {
    ...
    @IBAction func nextButtonTapped(_ sender: UIButton) {
        guard let vc = storyboard?.instantiateViewController(withIdentifier: "ThirdFiveViewController")
                as? ThirdFiveViewController else {
                    return
                }
