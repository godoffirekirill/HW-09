...
class ThirdOneViewController: UIViewController {
    ...
    @IBAction func nextButtonTapped(_ sender: UIButton) {
        guard let vc = storyboard?.instantiateViewController(withIdentifier: "ThirdTwoViewController")
                as? ThirdTwoViewController else {
                    return
                }
