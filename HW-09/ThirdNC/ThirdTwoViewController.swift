...
class ThirdTwoViewController: UIViewController {
    ...
    @IBAction func nextButtonTapped(_ sender: UIButton) {
        guard let vc = storyboard?.instantiateViewController(withIdentifier: "ThirdThreeViewController")
                as? ThirdThreeViewController else {
                    return
                }
